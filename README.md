...
| Plugin | What it does |
|--------|--------------|
| [session-continuity](plugins/session-continuity) | `/handoff` saves a portable snapshot of a conversation; `/resume` picks it back up. A baton pass, not a context restore. |
